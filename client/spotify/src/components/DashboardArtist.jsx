...
export const ArtistCard = ({ data, index }) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      await deleteArtistById(data._id);
      setIsDelete(false); // Close the delete confirmation
      // Now, you might want to update the state or refetch the artist data
      // For simplicity, you can refetch all artists
      const updatedArtists = await getAllArtist();
  ...
  return (
    ...
    >
      ...
      {isDelete && (
        ...
        <div className="bg-red-300 px-3 rounded-md"onClick={handleDelete} >
